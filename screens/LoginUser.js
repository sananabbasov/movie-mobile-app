...
const LoginUser = () => {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#fff' }}
      ...
      <View style={styles.bottomView}>
        <View style={{ padding: 40 }}>
          ...
          <Text>Don't have an account?
            <Text onPress={() => setModalOpen(true)}  style={{ color: 'red', fontStyle: 'italic' }}>
              {' '}
              Register now
            </Text>
          </Text>
          <View style={{marginTop: 50}}>
            ...
            <View style={{marginTop: 30}}>
              <Text style={{backgroundColor: '#676767', textAlign: 'center',padding: 10,width: '50%',color: '#fff'}}>Login</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      animationType='slide'
      >
        <Text onPress={() => setModalOpen(false)} ><AntDesign name="closecircleo" color={'#000'} size={32} /></Text>
            <RegisterUser />
